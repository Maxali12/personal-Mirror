...
class _BotCommands:
    def __init__(self):
        ...
        self.QbUnzipMirrorCommand = (f'qbunzipmirror{CMD_INDEX}', f'qbuzm{CMD_INDEX}')
        self.QbZipMirrorCommand = (f'qbzipmirror{CMD_INDEX}', f'qbzm{CMD_INDEX}')
        self.YtdlCommand = (f'ytdlp{CMD_INDEX}', f'yt{CMD_INDEX}')
        self.YtdlZipCommand = (f'ytdlzip{CMD_INDEX}', f'ytz{CMD_INDEX}')
        ...
        self.QbUnzipLeechCommand = (f'qbunzipleech{CMD_INDEX}', f'qbuzl{CMD_INDEX}')
        self.QbZipLeechCommand = (f'qbzipleech{CMD_INDEX}', f'qbzl{CMD_INDEX}')
        self.YtdlLeechCommand = (f'ytdlleech{CMD_INDEX}', f'ytl{CMD_INDEX}')
        self.YtdlZipLeechCommand = (f'ytdlzipleech{CMD_INDEX}', f'ytzl{CMD_INDEX}')
        ...
        self.ExecHelpCommand = f'help_exec{CMD_INDEX}'
