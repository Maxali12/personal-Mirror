...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("╚»★«╝ Mirror Group ╚»★«╝", "https://t.me/+XvFNNP762rcyOTll")
    buttons.buildbutton("Update", "https://t.me/mirrorcloudbd")
    buttons.buildbutton("Mirror Group 2", "https://t.me/mirrorcloudbd1")
    buttons.buildbutton("Owner", "https://t.me/bdbots")
